...
/rest/${instanceConfig.organization}/ems/ExternalReference?layout=ExternalId,ExternalStatus,ExternalSystem.SystemId&filter=${"EntityId='"+message.args.entity.entityId+"' and ExternalSystem.SystemId='"+message.args.linkedEntity.instanceAlias+"'"}
</#escape>
