...
/rest/${instanceConfig.organization}/ems/ExternalReference?layout=ExternalId,ExternalStatus,ExternalSystem.SystemId&filter=${"EntityId='"+message.entityChange.entityId+"' and ExternalSystem.SystemId='"+message.entityChange.data.externalInstanceAlias+"'"}
</#escape>
